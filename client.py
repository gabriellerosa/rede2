...
try:
    ...
    console.log(
        '[bold green]Conexão estabelecida com o servidor! :white_check_mark:')
    time.sleep(1)
    ...
    # Resultado da tentativa
        ...
        if (received_message['content']['game_over']):
            ...
            if (not received_message['content']['winner']):
                console.print('Suas tentativas se esgorataram! :disappointed:',
                              justify='center', style='bold red')
                console.print(
                    'A palavra era: [bold green]' + received_message['secret_word'], justify='center')

            else:
                console.print('Parabéns, você acertou! :tada: :tada: :smiley:',
        ...
        console.print(
            received_message['content']['message'], justify='center', style='bold red')
